...
class CowsBreeds (db.Model):
    ...
    tip_soderjaniya = db.Column(db.String, nullable = False)
    ...
    def __init__ (self, selfprice1, selfprice2, selfprice3, selfprice4, selfprice5 ):
        self.selfprice1=float(request.form['selfprice1'])
        self.selfprice2=float(request.form['selfprice2'])
        self.selfprice3=float(request.form['selfprice3'])
        self.selfprice4=float(request.form['selfprice4'])
        self.selfprice5=float(request.form['selfprice5'])
...
def deeper():
    ...
    db.session.add(CowsBreeds(selfprice1, selfprice2, selfprice3, selfprice4, selfprice5))
